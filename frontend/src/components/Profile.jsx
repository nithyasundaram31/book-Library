    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center'>
                <h1 className='mx-auto font-semibold text-xl p-6'>Profile</h1>
                
                <div className='w-full max-w-[600px] bg-white p-4 mb-8 border'>
                    <div className='flex justify-center items-center'>
<img className='rounded-full w-32 h-32 object-cover overflow-hidden' src="/profile.png" alt="Profile" />                    </div>
